 ...
 * @ModifiedDate Mar 26, 2009 - Add removeUnvalidCharacters(),combineBlankCharacters();
 * 
 */
public class Strings {
	...
	public static void main(String[] args) {
		System.err
				.println(Strings
						.translateSEOLink("25 years isca retrospectives and reprints25 years isca retrospectives and reprints25 years isca retrospectives and reprints25 years isca retrospectives "));
