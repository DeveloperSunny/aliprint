...
public class PatternTool {
	 ...
	 * @param patternString
	 * @param maxLine
	 *            Default 0 (unlimited if less then 0)
	 * @param groupIndex
	 *            Default 1.
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public static List<String[]> findAllMatches(String str, Pattern compliedPattern, int maxLine, int... groupIndex) {
	...
	public static List<String[]> findAllMatches(String str, String patternString, int maxLine, int... groupIndex) {
